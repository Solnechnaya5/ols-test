...
$(function () { var e = $(".logistic-bottom-slider"), a = $(".logistic-bottom-slider-next"), t = $(".logistic-bottom-slider-prev"); e.slick({ infinite: !0, speed: 300, slidesToShow: 1, nextArrow: a, prevArrow: t }) });
...
$(function () {
    var s = $("#project-specification")
        , t = $("#contact-email")
        , o = $("#contact-name")
        , r = $("#contact-tel")
        , e = s.attr("action");
    inputError(t, errorClass),
        inputError(o, errorClass),
        inputError(r, errorClass),
        r.focusout(function () {
            $(this).val() || $(this).removeClass(errorClass)
        }),
        s.submit(function (r) {
            if (r.preventDefault(),
                t.val() || t.addClass(errorClass),
                o.val() || o.addClass(errorClass),
                !s.find($(".form-input")).hasClass(errorClass)) {
                var a = s.serialize();
                return $.ajax({
                    type: "POST",
                    url: e + encodeURIComponent(location.href),
                    data: a,
                    success: function (r) {
                        //console.log(r)
                    }
...
const titleList = document.querySelectorAll(".about__title-item"), textList = document.querySelectorAll(".about__text-item"), openText = t => { [...textList].forEach(t => t.classList.remove("active")), [...textList][t].classList.add("active"), [...titleList].forEach(t => t.classList.remove("active")), [...titleList][t].classList.add("active") };[...titleList].forEach((t, e) => { t.addEventListener("click", () => openText(e)) });